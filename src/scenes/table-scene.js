...
export class TableScene extends Phaser.Scene {
    ...
    init(data) {
        ...
        this.server.setCallbacks({
            tablePlayersUpdate: (players) => {
                this.onPlayersUpdate(players);
            },
            tableDiceUpdate: (msg) => {
                this.onDiceUpdate(msg);
            },
            tableNoMames: (nmtype, audionum) => {
                this.onNoMames(nmtype, audionum);
            },
            tableReset: () => {
                this.onReset();
            },
            tablePassDirectionChange: (isClockwise) => {
                this.onPassDirectionChange(isClockwise);
            },
            tablePause: (pauseText) => {
    ...
    create(){
        ...
        this.fiverTryText = this.add.text(220,180, 'ROLLIN ROLLIN ROLLIN - GOING FOR IT!!',{color: 'red'});
        ...
        this.fiverWinText = this.add.text(220 , 180, '🎲🎲🎲🎲🎲 !! FIVE OF A KIND !! 🎲🎲🎲🎲🎲', {color: 'white'});
